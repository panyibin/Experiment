...
CFunctionTestDlg::CFunctionTestDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CFunctionTestDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CFunctionTestDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDOK, &CFunctionTestDlg::OnBnClickedOk)
END_MESSAGE_MAP()
...
void CFunctionTestDlg::OnBnClickedOk()
{
}
